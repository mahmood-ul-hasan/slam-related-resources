...
| ⭐2021 | FAST-LIO2   | FAST-LIO: A Fast, Robust LiDAR-Inertial Odometry Package               | 3D LiDAR, IMU     | Kalman filter for tightly coupled LiDAR and IMU                | [GitHub](https://github.com/hku-mars/FAST_LIO)                | [Paper](https://arxiv.org/pdf/2107.05307.pdf)                             | GPL-2.0  |
...
| Year | Short Name | Paper Name                                                              | Sensors           | Comments                                                        | GitHub Link                                                    | Paper Link                                                                  | License  |
|------|------------|-------------------------------------------------------------------------|-------------------|-----------------------------------------------------------------|---------------------------------------------------------------|-----------------------------------------------------------------------------|----------|
| 2024 | SR-LIVO    | SR-LIVO: LiDAR-Inertial-Visual Odometry and Mapping with Sweep Reconstruction | LiDAR, Visual     | Authors: Zikang Yuan, Jie Deng, Ruiye Ming, Fengtian Lang, Xin Yang | [GitHub](https://github.com/ZikangYuan/sr_livo)              | [arXiv](https://arxiv.org/abs/2312.16800)                  |          |
| 2024 | FAST-LIVO2 | FAST-LIVO2: Fast, Direct LiDAR-Inertial-Visual Odometry                | LiDAR, Visual, IMU     |  By hku-mars: Under review                                                   | [GitHub](https://github.com/hku-mars/FAST-LIVO2)             | [IEEE](https://ieeexplore.ieee.org/document/9739244)                       |          |
...
| 2022 | FAST-LIVO  | FAST-LIVO: Fast and Tightly-coupled Sparse-Direct LiDAR-Inertial-Visual Odometry   | LiDAR, Visual     | By hku-mars: system can only work in the hard synchronized LiDAR-Inertial-Visual dataset at present | [GitHub](https://github.com/hku-mars/FAST-LIVO)               | [IEEE](https://ieeexplore.ieee.org/document/9739244)                       | GPL-2.0  |
...
| 2024 | R3LIVE++   | R3LIVE++: A Robust, Real-time, Radiance reconstruction package with a tightly-coupled LiDAR-Inertial-Visual state Estimator | LiDAR, Visual     |  By hku-mars                                                                | [GitHub](https://github.com/hku-mars/r3live)                  | [arXiv](https://arxiv.org/abs/2209.03666)                                  | GPL-2.0  |
| 2022 | R3LIVE     | R3LIVE: A Robust, Real-time, RGB-colored, LiDAR-Inertial-Visual tightly-coupled state Estimation and mapping package | LiDAR, Visual     |      By hku-mars: To launch R3LIVE with spinning LIDAR, it requires you to take some effort in modifying the source code    | [GitHub](https://github.com/hku-mars/r3live)                  | [IEEE](https://ieeexplore.ieee.org/document/9811935)                       | GPL-2.0  |
